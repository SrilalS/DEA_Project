<nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
    <div class="container-fluid">
        ...
        <div style="margin-left: 16px">
            <button class="btn btn-outline-success btn-block" style="width: 128px">Shops</button>
        </div>
        <div style="margin-left: 16px">
            <button class="btn btn-outline-success btn-block" style="width: 128px">Customers</button>
        </div>
        <div style="margin-left: 16px">
            <button class="btn btn-success btn-block" style="width: 128px">Income</button>
        </div>
